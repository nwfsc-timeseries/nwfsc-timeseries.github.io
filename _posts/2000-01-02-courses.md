...
Online book based on the course.  The labs give hands on practice with ts functions in R, mulivariate time-series analysis, dynamic factor analysis, and dynamic linear modeling.  Includes R code.
</div>
</div>
